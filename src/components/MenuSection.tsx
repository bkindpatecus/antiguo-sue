...
const menuData: Category[] = [
  {
    ...
    items: [
      ...
      { name: "Tartar", desc: "Cubos de atún adobados en salsa Ponzu con sésamo y ceste cítrico montados sobre un tabulé de cuscus verde en una isla de crema ahumada con aceite de hierbas verdes y chips de tortillas.", price: "$14.900" },
      ...
      { name: "Ceviche Plant Base", desc: "Palmitos, alcachofas, choclo peruano, mango y verduras, reposadas en limón, sobre una cama de leche de tigre vegana de la casa y hojas verdes. Con chips de tortillas.", price: "$11.900", vegan: true },
